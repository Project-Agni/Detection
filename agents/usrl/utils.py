...
def get_argparser():
    ...
    parser.add_argument(
        "--epochs", type=int, default=100, help="Number of epochs for  (default: 100)"
    )
    parser.add_argument("--cuda-id", type=int, default=0, help="CUDA device index")
